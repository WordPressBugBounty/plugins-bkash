...
function softtech_nagad_plugin_activation() {
    ...
    class SoftTechIT_nagad extends WC_Payment_Gateway {
        ...
        public function __construct() {
            ...
            add_action( 'woocommerce_update_options_payment_gateways_' . $this->id, array( $this, 'nagad_process_upload_file' ) );
        }

        public function nagad_process_upload_file() {
            if ( isset( $_FILES['woocommerce_softtech_nagad_upload_file'] ) && !empty( $_FILES['woocommerce_softtech_nagad_upload_file']['name'] ) ) {
                ...
                $uploaded_file = $_FILES['woocommerce_softtech_nagad_upload_file'];
                ...
                if ( isset( $upload['url'] ) && !isset( $upload['error'] ) ) {
                    ...
                    update_option( 'nagad_rq_code_image', $upload['url'] );
                } else {
                    // Handle errors
        ...
        public function softtech_nagad_options_fields() {
            $this->form_fields = array(
                ...
                'upload_file'           => array(
                    ...
                    'type'        => 'file',
                    'description' => esc_html__( 'Upload your Nagad QR Code image here.', "stb" ),
                ),
                'nagad_upload_file_url' => array(
                    'type' => 'hidden',
                ),
            );
        }
        ...
        public function payment_fields() {
            ...
            // Display QR Code
            $qr_code_url = get_option( 'nagad_rq_code_image' );
            if ( $qr_code_url ) {
                echo '<img src="' . esc_url( $qr_code_url ) . '" class="nagad-qr-code-image" alt="Rocket QR Code">';
            }

            // Display nagad number
            ...
            <table border="0">
                ...
                <tr>
                    ...
                    <td><input class="widefat" type="text" name="nagad_transaction_id" id="nagad_transaction_id"
